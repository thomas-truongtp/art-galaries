      ...
      <div class="w-full lg:w-1/3 mt-8 lg:mt-0">
        <div class="bg-white p-4 rounded-md shadow-md">
          ...
          <div class="mt-4">
            ...
            <button class="mt-4 w-full bg-gray-800 text-white text-center py-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-50">
              Checkout
            </button>
          </div>
        </div>
